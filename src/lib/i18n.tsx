...
const translations: Record<Lang, Record<string, string>> = {
  id: {
    ...
    orderSummary:"Ringkasan Pesanan", subtotal:"Subtotal", productDiscounts:"Potongan produk", delivery:"Pengiriman", shippingAuto:"Ongkir otomatis", shippingAutoHint:"Ongkir toko sudah dimasukkan ke total checkout.", shippingAtCheckout:"Diatur saat checkout", free:"Gratis", tax:"Pajak", total:"Total", taxNote:"Pajak dihitung otomatis sesuai pengaturan toko. Untuk kebutuhan kepatuhan pajak, sesuaikan tarif dan status pajak toko.", promoCode:"Kode promo", apply:"Pakai", checkout:"Lanjut ke Pembayaran", emptyCart:"Keranjang belanja masih kosong.",
  ...
  en: {
    ...
    orderSummary:"Order Summary", subtotal:"Subtotal", productDiscounts:"Product discounts", delivery:"Delivery", shippingAuto:"Automatic shipping", shippingAutoHint:"The store shipping fee is already included in checkout.", shippingAtCheckout:"Set at checkout", free:"Free", tax:"Tax", total:"Total", taxNote:"Tax is calculated automatically from the store tax settings. Adjust the rate and tax status to match your business requirements.", promoCode:"Promo code", apply:"Apply", checkout:"Continue to Checkout", emptyCart:"Your shopping cart is empty.",
